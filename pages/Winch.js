...
export default class Winch extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
  ...
  add_winsh() {
    ...
    let data_to_send = {
      ...
      telephone: this.state.phonewinsh,
    };
    this.setState({ loading: true });
console.log(data_to_send)
    axios
      .post('https://zfactory.000webhostapp.com/CarApp/add_winsh.php', data_to_send)
      .then((res) => {
        ...
        >
          ...
          <ScrollView>
            ...
            <TouchableOpacity
              onPress={() => {
                if (
                   this.state.phonewinsh.length > 0
                ) {
                  this.add_winsh()
                } else {
                  alert('invalid data')
